...
import com.xj.loginlibrary.contants.Contants;
import com.xj.loginlibrary.R;
import com.xj.loginlibrary.model.Person;
import com.xj.loginlibrary.view.JellyInterpolator;
import com.xj.loginlibrary.view.Point;
import com.xj.loginlibrary.view.PointEvaluator;
            ...
            if (judgeInput()) {
                ...
                p2.save(new SaveListener<String>() {
                    ...
                    public void done(String objectId,BmobException e) {
                        if(e==null){
                            ToastUtils.showToast("添加数据成功，返回objectId为："+objectId);
